...
public class StoresCURDTestWithSteps extends TestBase{
    ...
    static String address = "7 Artisan"+ TestUtils.getRandomValue();
    static String address2 = "Almer Street"+ TestUtils.getRandomValue();
    static String city = "London"+ TestUtils.getRandomValue();
    static String state = "South"+ TestUtils.getRandomValue();
